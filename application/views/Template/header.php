...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/styles/css/font-awesome.min.css">
          ...
          <div class="col-md-12">
            <div class="navbar-header">
              <a class="navbar-brand" href="#">
                <img src="<?= base_url(); ?>assets/styles/logos/logo-tym-2025.png" alt="TYMQRO Logo" style="width:60px;" class="rounded-pill"> 
              </a>
            </div>
            <div class="collapse navbar-collapse navbar-right" id="mynavbar">
              <ul class="nav navbar-nav">
                ...
                <li><a href="#sucediendo">¿Que esta sucediendo?</a></li>
                <li><a href="#grupos">Grupos Cafés</a></li>
