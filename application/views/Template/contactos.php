      ...
      <div class="row white">
        <div class="col-md-8 col-sm-12">
          <div class="section-title">
            ...
            <hr class="botm-line">
            <p class="sec-para black">Estamos para servirte contactanos por alguno de nuestros canales de comunicación, será un placer atenderte.</p>
          </div>
        </div>
        <div class="col-md-12 col-sm-12">
          <div class="col-md-4 col-sm-6" style="padding-left:0px;">
            <h3 class="cont-title">Nuestro correo</h3>
